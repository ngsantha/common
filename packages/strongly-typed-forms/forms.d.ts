...
export declare abstract class AbstractControl<T> {
   ...
   */
  constructor(validators: ValidatorFn<T> | ValidatorFn<T>[] | null, asyncValidators: AsyncValidatorFn<T> | AsyncValidatorFn<T>[] | null);
  /**
  ...
  set validator(validatorFn: ValidatorFn<T> | null);
  /**
  ...
  set asyncValidator(asyncValidatorFn: AsyncValidatorFn<T> | null);
  /**
   * The parent control.
   */
   ...
   * * `this.form.get(['items', 0, 'price']);`
   */
  get<T>(path: Array<string | number> | string): AbstractControl<T> | null;
  /**
   * @description
 ...
 * @publicApi
 */
export declare abstract class AbstractControlDirective<T> {
  /**
   * @description
   ...
   */
  abstract get control(): AbstractControl<T> | null;
  /**
   * @description
   ...
   * directive.
   */
  get validator(): ValidatorFn<any> | null;
  /**
   * @description
   * Asynchronous validator function composed of all the asynchronous validators registered with
   * this directive.
   */
  get asyncValidator(): AsyncValidatorFn<any> | null;
 ...
 * @publicApi
 */
export declare interface AbstractControlOptions<T> {
  /**
   * @description
...
declare class AbstractControlStatus {
  private _cd;
  constructor(cd: AbstractControlDirective<any> | null);
 ...
 * @publicApi
 */
export declare class AbstractFormGroupDirective<T> extends ControlContainer<T> implements OnInit, OnDestroy {
  /** @nodoc */
  ngOnInit(): void;
  /** @nodoc */
  ngOnDestroy(): void;
  ...
  get formDirective(): Form | null;
    static ɵfac: i0.ɵɵFactoryDeclaration<AbstractFormGroupDirective<any>, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<AbstractFormGroupDirective<any>, never, never, {}, {}, never>;
}
...
export declare interface AsyncValidator extends Validator {
   ...
   */
  validate(control: AbstractControl<any>): Promise<ValidationErrors | null> | Observable<ValidationErrors | null>;
}
 ...
 * @publicApi
 */
export declare abstract class ControlContainer<T> extends AbstractControlDirective<T> {
  /**
   * @description
...
export declare interface Form {
   ...
   */
  addControl(dir: NgControl<any>): void;
  /**
   * @description
   ...
   */
  removeControl(dir: NgControl<any>): void;
  /**
   * @description
   ...
   */
  getControl<T>(dir: NgControl<T>): FormControl<T>;
  /**
   * @description
   ...
   */
  addFormGroup(dir: AbstractFormGroupDirective<any>): void;
  /**
   * @description
   ...
   */
  removeFormGroup(dir: AbstractFormGroupDirective<any>): void;
  /**
   * @description
   ...
   */
  getFormGroup<T>(dir: AbstractFormGroupDirective<T>): FormGroup<T>;
  /**
   * @description
   ...
   */
  updateModel<T>(dir: NgControl<T>, value: T): void;
}
...
export declare class FormArray<T> extends AbstractControl<T[]> {
   ...
   *
   */
  constructor(controls: AbstractControl<T>[], validatorOrOpts?: ValidatorFn<T> | ValidatorFn<T>[] | AbstractControlOptions<T> | null, asyncValidator?: AsyncValidatorFn<T> | AsyncValidatorFn<T>[] | null);
  /**
 ...
 * @publicApi
 */
export declare class FormArrayName<T> extends ControlContainer<T[]> implements OnInit, OnDestroy {
  /**
   * @description
   ...
   */
  name: string | number | null;
  constructor(parent: ControlContainer<any>, validators: (Validator | ValidatorFn<T>)[], asyncValidators: (AsyncValidator | AsyncValidatorFn<T>)[]);
  /**
   ...
   */
  get control(): FormArray<T>;
  /**
   * @description
   * The top-level directive for this group if present, otherwise null.
   */
  get formDirective(): FormGroupDirective<T> | null;
  /**
   * @description
   * Returns an array that represents the path from the top-level form to this control.
   * Each index is the string name of the control on that level.
  ...
  private _checkParentType;
    static ɵfac: i0.ɵɵFactoryDeclaration<FormArrayName<any>, [{ optional: true; host: true; skipSelf: true; }, { optional: true; self: true; }, { optional: true; self: true; }]>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<FormArrayName<any>, "[formArrayName]", never, { "name": "formArrayName"; }, {}, never>;
}
...
export declare class FormBuilder {
   ...
   * submit')
   */
  group<T>(controlsConfig: ControlConfig<T>, options?: AbstractControlOptions<T> | null): FormGroup<T>;
   ...
   * </code-example>
   */
  control<T>(formState: FormState<T>, validatorOrOpts?: ValidatorFn<T> | ValidatorFn<T>[] | AbstractControlOptions<T> | null, asyncValidator?: AsyncValidatorFn<T> | AsyncValidatorFn<T>[] | null): FormControl<T>;
  /**
   ...
   * functions.
   */
  array<T>(controlsConfig: ControlConfig<T>[], validatorOrOpts?: ValidatorFn<T> | ValidatorFn<T>[] | AbstractControlOptions<T> | null, asyncValidator?: AsyncValidatorFn<T> | AsyncValidatorFn<T>[] | null): FormArray<T>;
...
export declare class FormControl<T> extends AbstractControl<T> {
   ...
   *
   */
  constructor(formState?: FormState<T>, validatorOrOpts?: ValidatorFn<T> | ValidatorFn<T>[] | AbstractControlOptions<T> | null, asyncValidator?: AsyncValidatorFn<T> | AsyncValidatorFn<T>[] | null);
  /**
 ...
 * @publicApi
 */
export declare class FormControlDirective<T> extends NgControl<T> implements OnChanges, OnDestroy {
  ...
  constructor(validators: (Validator | ValidatorFn<T>)[], asyncValidators: (AsyncValidator | AsyncValidatorFn<T>)[], valueAccessors: ControlValueAccessor[], _ngModelWarningConfig: string | null);
  /** @nodoc */
  ngOnChanges(changes: SimpleChanges): void;
  /** @nodoc */
  ngOnDestroy(): void;
  ...
  private _isControlChanged;
    static ɵfac: i0.ɵɵFactoryDeclaration<FormControlDirective<any>, [{ optional: true; self: true; }, { optional: true; self: true; }, { optional: true; self: true; }, { optional: true; }]>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<FormControlDirective<any>, "[formControl]", ["ngForm"], { "form": "formControl"; "isDisabled": "disabled"; "model": "ngModel"; }, { "update": "ngModelChange"; }, never>;
}
 ...
 * @publicApi
 */
export declare class FormControlName<T> extends NgControl<T> implements OnChanges, OnDestroy {
  private _ngModelWarningConfig;
  private _added;
  /**
   * @description
  ...
  /** @deprecated as of v6 */
  update: EventEmitter<any>;
  constructor(parent: ControlContainer<T>, validators: (Validator | ValidatorFn<T>)[], asyncValidators: (AsyncValidator | AsyncValidatorFn<T>)[], valueAccessors: ControlValueAccessor[], _ngModelWarningConfig: string | null);
  /** @nodoc */
  ngOnChanges(changes: SimpleChanges): void;
  /** @nodoc */
  ngOnDestroy(): void;
  ...
  private _setUpControl;
    static ɵfac: i0.ɵɵFactoryDeclaration<FormControlName<any>, [{ optional: true; host: true; skipSelf: true; }, { optional: true; self: true; }, { optional: true; self: true; }, { optional: true; self: true; }, { optional: true; }]>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<FormControlName<any>, "[formControlName]", never, { "name": "formControlName"; "isDisabled": "disabled"; "model": "ngModel"; }, { "update": "ngModelChange"; }, never>;
}
...
export declare class FormGroup<T> extends AbstractControl<T> {
   ...
   *
   */
  constructor(controls: Controls<T>, validatorOrOpts?: ValidatorFn<T> | ValidatorFn<T>[] | AbstractControlOptions<T> | null, asyncValidator?: AsyncValidatorFn<T> | AsyncValidatorFn<T>[] | null);
  /**
   ...
   * replaced with a new one. When false, no events are emitted.
   */
  setControl<K extends keyof T>(name: K, control: AbstractControl<T>, options?: {
    emitEvent?: boolean;
  }): void;
  /**
 ...
 * @publicApi
 */
export declare class FormGroupDirective<T> extends ControlContainer<T> implements Form, OnChanges, OnDestroy {
  private validators;
   ...
   */
  directives: FormControlName<any>[];
  /**
   * @description
  ...
  constructor(validators: (Validator | ValidatorFn<T>)[], asyncValidators: (AsyncValidator | AsyncValidatorFn<T>)[]);
  /** @nodoc */
  ngOnChanges(changes: SimpleChanges): void;
  /** @nodoc */
  ngOnDestroy(): void;
   ...
   */
  addControl(dir: FormControlName<T>): FormControl<T>;
  /**
   * @description
   ...
   * @param dir The `FormControlName` directive instance.
   */
  getControl<T>(dir: FormControlName<T>): FormControl<T>;
  /**
   * @description
   ...
   * @param dir The `FormControlName` directive instance.
   */
  removeControl(dir: FormControlName<any>): void;
  /**
   * Adds a new `FormGroupName` directive instance to the form.
   *
   * @param dir The `FormGroupName` directive instance.
   */
  addFormGroup(dir: FormGroupName<any>): void;
  /**
   ...
   * @param dir The `FormGroupName` directive instance.
   */
  removeFormGroup(dir: FormGroupName<any>): void;
  /**
   * @description
   ...
   * @param dir The `FormGroupName` directive instance.
   */
  getFormGroup<T>(dir: FormGroupName<T>): FormGroup<T>;
  /**
   * Performs the necessary setup when a `FormArrayName` directive instance is added to the view.
   *
   * @param dir The `FormArrayName` directive instance.
   */
  addFormArray(dir: FormArrayName<any>): void;
  /**
   ...
   * @param dir The `FormArrayName` directive instance.
   */
  removeFormArray(dir: FormArrayName<any>): void;
  /**
   * @description
   ...
   * @param dir The `FormArrayName` directive instance.
   */
  getFormArray(dir: FormArrayName<any>): FormArray<any>;
  /**
   ...
   */
  updateModel<T>(dir: FormControlName<T>, value: T): void;
  /**
   * @description
  ...
  private _checkFormPresent;
    static ɵfac: i0.ɵɵFactoryDeclaration<FormGroupDirective<any>, [{ optional: true; self: true; }, { optional: true; self: true; }]>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<FormGroupDirective<any>, "[formGroup]", ["ngForm"], { "form": "formGroup"; }, { "ngSubmit": "ngSubmit"; }, never>;
}
 ...
 * @publicApi
 */
export declare class FormGroupName<T> extends AbstractFormGroupDirective<T> implements OnInit, OnDestroy {
  /**
   * @description
   ...
   */
  name: string | number | null;
  constructor(parent: ControlContainer<T>, validators: (Validator | ValidatorFn<T>)[], asyncValidators: (AsyncValidator | AsyncValidatorFn<T>)[]);
  static ɵfac: i0.ɵɵFactoryDeclaration<FormGroupName<any>, [{ optional: true; host: true; skipSelf: true; }, { optional: true; self: true; }, { optional: true; self: true; }]>;
  static ɵdir: i0.ɵɵDirectiveDeclaration<FormGroupName<any>, "[formGroupName]", never, { "name": "formGroupName"; }, {}, never>;
}
 ...
 * @publicApi
 */
export declare abstract class NgControl<T> extends AbstractControlDirective<T> {
  /**
   * @description
   * The name for the control
   */
...
export declare class NgControlStatusGroup extends AbstractControlStatus {
  constructor(cd: ControlContainer<any>);
 ...
 * @publicApi
 */
export declare class NgForm<T> extends ControlContainer<T> implements Form, AfterViewInit {
  /**
   * @description
   ...
   */
  addControl(dir: NgModel<any>): void;
  /**
   * @description
   ...
   * @param dir The `NgModel` directive instance.
   */
  getControl<T>(dir: NgModel<T>): FormControl<T>;
  /**
   * @description
   ...
   * @param dir The `NgModel` directive instance.
   */
  removeControl(dir: NgModel<any>): void;
  /**
   * @description
   ...
   */
  addFormGroup(dir: NgModelGroup<any>): void;
  /**
   * @description
   ...
   * @param dir The `NgModelGroup` directive instance.
   */
  removeFormGroup(dir: NgModelGroup<any>): void;
  /**
   * @description
   ...
   * @param dir The `NgModelGroup` directive instance.
   */
  getFormGroup(dir: NgModelGroup<any>): FormGroup<any>;
  /**
  ...
  private _setUpdateStrategy;
    static ɵfac: i0.ɵɵFactoryDeclaration<NgForm<any>, [{ optional: true; self: true; }, { optional: true; self: true; }]>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgForm<any>, "form:not([ngNoForm]):not([formGroup]),ng-form,[ngForm]", ["ngForm"], { "options": "ngFormOptions"; }, { "ngSubmit": "ngSubmit"; }, never>;
}
 ...
 * @publicApi
 */
export declare class NgModel<T> extends NgControl<T> implements OnChanges, OnDestroy {
  readonly control: FormControl<T>;
  /** @nodoc */
   ...
   */
  update: EventEmitter<any>;
  constructor(parent: ControlContainer<T>, validators: (Validator | ValidatorFn<T>)[], asyncValidators: (AsyncValidator | AsyncValidatorFn<T>)[], valueAccessors: ControlValueAccessor[]);
  /** @nodoc */
  ngOnChanges(changes: SimpleChanges): void;
  /** @nodoc */
  ngOnDestroy(): void;
  ...
  private _updateDisabled;
    static ɵfac: i0.ɵɵFactoryDeclaration<NgModel<any>, [{ optional: true; host: true; }, { optional: true; self: true; }, { optional: true; self: true; }, { optional: true; self: true; }]>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgModel<any>, "[ngModel]:not([formControlName]):not([formControl])", ["ngModel"], { "name": "name"; "isDisabled": "disabled"; "model": "ngModel"; "options": "ngModelOptions"; }, { "update": "ngModelChange"; }, never>;
}
 ...
 * @publicApi
 */
export declare class NgModelGroup<T> extends AbstractFormGroupDirective<T> implements OnInit, OnDestroy {
  /**
   * @description
  ...
  name: string;
  constructor(parent: ControlContainer<T>, validators: (Validator | ValidatorFn<T>)[], asyncValidators: (AsyncValidator | AsyncValidatorFn<T>)[]);
  static ɵfac: i0.ɵɵFactoryDeclaration<NgModelGroup<any>, [{ host: true; skipSelf: true; }, { optional: true; self: true; }, { optional: true; self: true; }]>;
  static ɵdir: i0.ɵɵDirectiveDeclaration<NgModelGroup<any>, "[ngModelGroup]", ["ngModelGroup"], { "name": "ngModelGroup"; }, {}, never>;
}
...
declare class RadioControlRegistry {
   ...
   */
  add(control: NgControl<any>, accessor: RadioControlValueAccessor): void;
  /**
   * @description
...
export declare class Validators {
   ...
   *
   */
  static requiredTrue(control: AbstractControl<boolean>): ValidationErrors | null;
  /**
   * @description
   ...
   *
   */
  static minLength(minLength: number): ValidatorFn<string>;
  /**
   * @description
   ...
   *
   */
  static maxLength(maxLength: number): ValidatorFn<string>;
  /**
   * @description
   ...
   *
   */
  static pattern(pattern: string | RegExp): ValidatorFn<string>;
  /**
   * @description
   ...
   *
   */
  static nullValidator(control: AbstractControl<any>): ValidationErrors | null;
  /**
   * @description
  ...
  static compose(validators: (ValidatorFn<any> | null | undefined)[]): ValidatorFn<any> | null;
  /**
   * @description
   ...
   *
   */
  static composeAsync(validators: (AsyncValidatorFn<any> | null)[]): AsyncValidatorFn<any> | null;
}
